下文给出了[X.680文档](http://www.itu.int/rec/T-REC-X.680-201508-I/en "X.680文档")中的所有文法规则。基本遵循了[X.680文档](http://www.itu.int/rec/T-REC-X.680-201508-I/en "X.680文档")的文法定义，修正了几处错误，并且在每个文法尾部增加了一个分号用于肉眼区分不同文法。

完整的文法定义可参见[http://107.167.183.202/bs.html](http://107.167.183.202/bs.html "http://107.167.183.202/bs.html")
...
;
ArcIdentifier ::=
        integer UnicodeLabel
    |   non-integer UnicodeLabel
;
XMLIRIValue ::=
