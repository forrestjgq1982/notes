...
macro __InstallEdit()
{
     ...
     */
    AssignKeyToCmd(3150, eDragLineDown)  /* Ctrl+Alt+N */
    AssignKeyToCmd(3152, eDragLineUp)    /* Ctrl+Alt+P */

    /**
     * Insert new line before or after current line
     */
    AssignKeyToCmd(1097, eInsertLine)     /* Alt+I */
    AssignKeyToCmd(1097, eInsertLineBeforeNext) /*  Ctrl+I */
     ...
     */
    AssignKeyToCmd(1098, eJoinLines) /* Ctrl+J */
     ...
     */
    AssignKeyToCmd(1109, eCutLine) /* Ctrl+U */
     ...
     */
    AssignKeyToCmd(3116, eIndentLeft) /* Ctrl+Alt+,(<) */
    AssignKeyToCmd(3118, eIndentRight) /* Ctrl+Alt+.(>) */
...
macro __InstallView()
{
     ...
     * windows.
     */
    AssignKeyToCmd(1033, eLastWindow) /* Ctrl+Tab */
 ...
 */
macro __InstallMotion()
{
    /**
     * Basic movement by direction keys
     */
    AssignKeyToCmd(32805, e_MoveToPrevChar)  /* Left */
    AssignKeyToCmd(32807, e_MoveToNextChar) /* Right */
    AssignKeyToCmd(32806, e_MoveToPrevLine)    /* Up */
    AssignKeyToCmd(32808, e_MoveToNextLine)  /* Down */
     ...
     * and end of block
     */
    AssignKeyToCmd(1883, eBlockUp) /* Ctrl+Shift+[ */
    AssignKeyToCmd(1885, eBlockDown) /* Ctrl+Shift+] */

    /**
     * Jump between the start or end of ( and ) pair
     */
    AssignKeyToCmd(1072, eParenRight) /* Ctrl+0 */
    AssignKeyToCmd(1081, eParenLeft) /* Ctrl+9 */
    ...
    */
    AssignKeyToCmd(33832, eBlankLineDown) /* Ctrl+Down */
    AssignKeyToCmd(33830, eBlankLineUp) /* Ctrl+Up */

    /**
     * Jump to previous or next function
     */
    AssignKeyToCmd(3117, eFunctionUp)   /* Ctrl+Alt+- */
    AssignKeyToCmd(3133, eFunctionDown) /* Ctrl+Alt+= */
...
macro __InstallSelection()
{
     ...
     */
    AssignKeyToCmd(2093, eSelectFuncOrSym) /* Alt+- */
     ...
     */
    AssignKeyToCmd(2109, eSelectMatch) /* Alt+= */

    /**
     * Select current line
     */
    AssignKeyToCmd(2892, eSelectLine) /* Alt+Shift+L */
    
    /**
     * Select current word where cursor locates
     */
    AssignKeyToCmd(2903, eSelectWord) /* Alt+Shift+W */
     ...
     */
    AssignKeyToCmd(1069, eSelectBlock) /* Ctrl+- */
    
    /**
     * Select a paragraph which is seperated by blank lines
     * or lines only containing whitespaces
     */
    AssignKeyToCmd(1085, eSelectParagraph) /* Ctrl+= */
    
    /**
     * Cancel current selection and jump to the beginning 
     * or end of selection
     */
    AssignKeyToCmd(3163, eBeginOfSelection) /* Ctrl+Alt+[ */
    AssignKeyToCmd(3165, eEndOfSelection) /* Ctrl+Alt+] */
...
macro __InstallNavi()
{
     ...
     * one by each
     */
    AssignKeyToCmd(2125, eGoBackToggle) /* Alt+M */
     ...
     */
    AssignKeyToCmd(1095, eGotoLine) /* Ctrl+G */
...
macro __InstallHistory()
{
     ...
     * is opened.
     */
    AssignKeyToCmd(2162, eRedo) /* Alt+R */
    AssignKeyToCmd(1114, "eUndo") /* Ctrl+Z */
    AssignKeyToCmd(1071, eUndoAll) /* Ctrl+/ */
...
macro __InstallSrch()
{
     ...
     * Open search dialog
     */
    AssignKeyToCmd(1107, eSrch) /* Ctrl+S */
    /**
     * Continue search backward or forward
     */
    AssignKeyToCmd(4210, eSrchBwd) /* F3 */
    AssignKeyToCmd(4211, eSrchFwd) /* F4 */
     ...
     */
    AssignKeyToCmd(4218, eIncSrchBwd) /* F11 */
    AssignKeyToCmd(4219, eIncSrchFwd) /* F12 */

    /**
     * Search backward or forward for selected characters or current
     * word under cursor if nothing is selected
     */
    AssignKeyToCmd(4978, eSrchSelBwd) /* Shift+F3 */
    AssignKeyToCmd(4979, eSrchSelFwd) /* Shift+F4 */
     ...
     */
    AssignKeyToCmd(2131, eLookupRef) /* Alt+S */

    /**
     * Open search files dialog
     */
    AssignKeyToCmd(3155, eSrchFiles) /* Ctrl+Alt+S */
     ...
     */
    AssignKeyToCmd(1068, ePrevLink) /* Ctrl+, */
    AssignKeyToCmd(1070, eNextLink) /* Ctrl+. */
    
    /**
     * Open Replace dialog
     */
    AssignKeyToCmd(1096, eReplace) /* Ctrl+H */
    /**
     * Open Replace Files dialog
     */
    AssignKeyToCmd(1864, eReplaceFiles) /* Ctrl+Shift+H */

}
macro __InstallClipboard()
{
    /**
